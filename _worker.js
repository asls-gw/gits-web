...
// API key set in: Cloudflare Pages → Settings → Environment Variables
//   RESEND_API_KEY = re_xxxxxxx  (mark Encrypt = ON)
//
// This handles POST /contact — the form submits here
// ============================================================
